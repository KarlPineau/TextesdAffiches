...
angular.module('angucomplete', [] )
    ...
    return {
        ...
        '               <a href="#!/search/movies/{{ searchStr }}" class="btn btn-default" type="button" title="Recherche par film"><i class="fa fa-film" aria-hidden="true"></i></a>'+
        '               <a href="#!/search/books/{{ searchStr }}" class="btn btn-default" type="button" title="Recherche par ouvrage"><i class="fa fa-book" aria-hidden="true"></i></a>'+
        '           </span>' +
        '       </div>'+
